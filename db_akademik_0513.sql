...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 25 Jan 2022 pada 11.59
...
--
-- Database: `db_akademik_0513`
--

-- --------------------------------------------------------

--
-- Struktur dari tabel `tbl_students_0513`
--

CREATE TABLE `tbl_students_0513` (
  `id` int(10) NOT NULL,
...
--
-- Dumping data untuk tabel `tbl_students_0513`
--

INSERT INTO `tbl_students_0513` (`id`, `nim`, `nama`, `jk`, `jurusan`, `alamat`) VALUES
...
--
-- Indeks untuk tabel `tbl_students_0513`
--
ALTER TABLE `tbl_students_0513`
  ADD PRIMARY KEY (`id`);
COMMIT;
